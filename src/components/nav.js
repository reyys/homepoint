...
function Nav() {
    return (
        <div className='w-full bg-[#6999B8] px-12 h-[8vh] flex items-center'>
            <Link to="/">
                <img className="max-w-[140px]" src={Logo} alt="Homepoint" />
            </Link>
            <div className='flex ml-40 items-center relative'>
